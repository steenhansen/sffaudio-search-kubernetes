...
var ParserTsvText = rootAppRequire('common-node/build-nodes/mediaServer/modules/base/ParserTsvText');
...
function read_text(tsv_text) {
    var parser_tsv_text = new ParserTsvText(csv_parse, tsv_text, graph_constants.CSV_PARSER_OPTIONS)
